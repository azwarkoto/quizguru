        ...
        ?>
         ...
         <?php 
          $no++;
            ...
            echo '<div class="alert alert-danger">Belum ada soal quis untuk mata pelajaran tersebut. Silakan pilih mata pelajaran..</div>';
         }
         ?>
      </div>
    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Input Soal Quis</h4>
      </div>
